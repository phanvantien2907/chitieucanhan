...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center bg-linear-to-b from-muted/40 to-background px-4 py-10 sm:px-6">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full cursor-pointer transition-colors hover:bg-muted"
                    size="lg"
